    ...
    >
      ...
      <div className={styles.main}>
        ...
        {!isLoading && vacancies.length === 0 && (
          <div className={styles.message}>
            <span className={styles.message__text}>Ничего не найдено</span>
          </div>
        )}
        <div className={styles.search}>
          ...
          >
            <span className={styles.search__button__text}>Найти</span>
          </div>
          <span className={styles.search__total}>
            {info && info.totalVacancies ? info.totalVacancies : 0} вакансий
          </span>
        </div>
